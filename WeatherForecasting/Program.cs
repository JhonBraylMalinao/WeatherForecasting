        ...
        static void Main(string[] args)
        {
                ...
                switch (choice)
            {
                case "1":
                        ...
                        Wind BaybayWind = new Wind(12, "East-West");
                        Console.WriteLine(BaybayWind.ToString());
                        break;
                case "2":
                        Console.WriteLine("\nHINDANG CITY WEATHER INFORMATION");
                        Place Hindang = new Place("Hindang", "8", "10.4305° N", "124.7442° E");
                        Console.WriteLine(Hindang.ToString());
                        Wind HindangWind = new Wind(3, "North-East");
                        Console.WriteLine(HindangWind.ToString());
                        break;
                case "3":
                ...
                case "6":
                        ...
                        Wind TaclobanWind = new Wind(12, "East-West");
                        Console.WriteLine(TaclobanWind.ToString());
                        break;
                default:
